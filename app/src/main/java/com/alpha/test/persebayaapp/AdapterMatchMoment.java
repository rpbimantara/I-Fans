...
public class AdapterMatchMoment extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MatchMomentViewHolder extends RecyclerView.ViewHolder{
        ...
        public MatchMomentViewHolder(@NonNull View itemView) {
            super(itemView);
            icon = itemView.findViewById(R.id.icon_moment);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_NORMAL) {
            ...
            if (dataList.get(position).getEvent().equalsIgnoreCase("Goal") || dataList.get(position).getEvent().equalsIgnoreCase("Goal Penalty")){
                holder.icon.setImageResource(R.drawable.goal);
            }else if(dataList.get(position).getEvent().equalsIgnoreCase("Subtitution")){
                holder.icon.setImageResource(R.drawable.subtitute);
            }else if(dataList.get(position).getEvent().equalsIgnoreCase("Yellow Card")){
                holder.icon.setImageResource(R.drawable.yellow);
            }else if(dataList.get(position).getEvent().equalsIgnoreCase("Red Card")){
                holder.icon.setImageResource(R.drawable.red);
            }
